...
using PinkWorld.Prism.Models.Dashboard;
using Prism.Navigation;
using Syncfusion.SfChart.XForms;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace PinkWorld.Prism.ViewModels.Dashboard
{
    /// <summary>
    ...
    public class StockOverviewViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public StockOverviewViewModel(INavigationService navigationService):base(navigationService)
        {
            GetChartData();
            ...
            LoadUser();
            ProfileImage = User.ImageFullPath;
        }
